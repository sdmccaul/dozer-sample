...
harvestProcessSchema = Schema({
	...
	'created_date'			:	Attribute(bharvest.creationDate, optional=True),
	...
	'filter_param'			:	Attribute(bharvest.filterParam, optional=True),
	...
	'other_term'			:	Attribute(bharvest.otherTerm, optional=True),
	...
	'text_word'				:	Attribute(bharvest.textWord, optional=True),
